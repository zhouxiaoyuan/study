...
|[chgrp](https://github.com/zhouxiaoyuan/study/blob/master/docs/tool/hd/fs/chgrp.md)|Change group association of files. The user must be the owner of files, or else a super-user.<br> Additional information is in the Permissions Guide.<br><br>`Usage: hadoop fs -chgrp [-R] GROUP URI [URI ...]`|
